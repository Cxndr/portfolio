            ...
            <div className="h-10/12 flex flex-col gap-16">
              ...
              <div className="h-[32.5%] flex flex-row gap-24 mt-16">
                ...
                <iframe 
                  ...
                  className="min-h-2 rounded-md mt-4 border-2 border-th-neutral-950 shadow-th-md shadow-th-pink-500"
                />
              ...
              <div className="w-full grow min-h-0 flex flex-col justify-between gap-16">
                ...
                <iframe 
                  width="50%" 
                  className="ml-32 h-full min-h-2 rounded-md border-2 border-th-neutral-950 shadow-th-md shadow-th-yellow-500"
                ...
                <iframe 
                  width="50%" 
                  className="ml-56 h-full min-h-2 rounded-md border-2 border-th-neutral-950 shadow-th-md shadow-th-blue-500"
                ...
                <iframe 
                  width="50%"
                  className="ml-4 h-full min-h-2 rounded-md border-2 border-th-neutral-950 shadow-th-md shadow-th-yellow-500"
